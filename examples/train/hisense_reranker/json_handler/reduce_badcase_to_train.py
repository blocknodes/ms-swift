...
def execute_command(command: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # 'content':item['content'], 'score':item['score'],"llm_relervance" : 0} for item in qnas]

        #docs = parsed_stdout['records']['docRunResult']['segmentAfterRerankResult']
        #if docs == '':
        #    docs = []
        #else:
        #    docs = [{'filename':item['fileName'], 'content':item['segmentContent'], 'score':item['score'], "llm_relervance" : 0} for item in docs]
